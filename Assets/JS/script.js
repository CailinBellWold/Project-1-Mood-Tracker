...
$("#sunny").on("click", function() {
    ...
    $("h4").text("Fun in the Sun!")
    $("h4").text("Fun in the Sun!").css("color", "black");
});
...
$("#cloudy").on("click", function() {
    ...
    $("h4").text("Cloudy day at the Beach!").css("color", "white");
});
...
$("#raining").on("click", function() {
    ...
    $("h4").text("Splashing in puddles!").css("color", "white");
});
...
$("#snowing").on("click", function() {
    ...
    $("h4").text("Building a snowman!").css("color", "black");
});